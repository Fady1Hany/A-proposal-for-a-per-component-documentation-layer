...
So, literally, what needs to be present in the AI's context window is the loop described in [Readme](https://github.com/Fady1Hany/A-proposal-for-a-per-component-documentation-layer/blob/main/README.md) , component.md , the code of the component it is currently modifying, and the saved path or copy of that component's code from before the modification.
